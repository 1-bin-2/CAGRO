    ...
    def __init__(
        ...
        if self.ref_model is not None:
            if self.is_deepspeed_enabled:
                self.ref_model = prepare_deepspeed(self.ref_model, self.args.per_device_train_batch_size, fp16=getattr(self.args, "fp16", False), bf16=getattr(self.args, "bf16", False))
            else:
